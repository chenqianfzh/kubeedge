...
// ArktosedgeV1Client is used to interact with features provided by the arktosedge.kubeedge.io group.
type ArktosedgeV1Client struct {
	restClient rest.Interface
}

func (c *ArktosedgeV1Client) Missions() MissionInterface {
	return newMissions(c)
}
...
func NewForConfig(c *rest.Config) (*ArktosedgeV1Client, error) {
	...
	return &ArktosedgeV1Client{client}, nil
}
